---
title: "Grafico di Dumbbell dinamico realizzato con flexdashboard - Versione per shinyapps.io"
author: "SM"
...
#---------------------------------------
fileData <- eventReactive(input$input_file,{
    ddf <- read.csv(input$input_file$datapath, header = TRUE, strip.white = TRUE)
...
```{r}
fileInput("input_file", "Scegli il file CSV:",
          multiple = FALSE,
...
#### box1
```{r}
renderText(input$input_file$datapath)
```
